...
### KeepLand
- 负责 Keepland 线下运动空间播放教学系统的设计、开发、维护、运维及空间智能化改造
...
- [体感游戏](/archives/images/motionSensingame.gif)实现100ms延迟以下视频传输 (3D景深摄像头与游戏服务器连接负责骨骼、动作识别，Android 盒子负责展示结果。使用 Netty 传输原始视频帧)
